...
def button():
	BUTTON=[[InlineKeyboardButton(text="👨‍💻 Sahibim",url="t.me/Rotabots")]]
	BUTTON+=[[InlineKeyboardButton(text="📣 Kanal",url="t.me/RotaKanal")]]
...
@K_G.on_message(filters.command("irem"))
async def _(client, message):
